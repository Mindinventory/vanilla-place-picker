...
* Implementation
    ...
    ```kotlin
            ...
            val intent = VanillaPlacePicker.Builder(this)
                 ...
                 */
                .with(VanillaPickerType.MAP_WITH_AUTO_COMPLETE) // Select Picker type to enable autocompelte, map or both
                .setMapType(VanillaMapType.MAP_TYPE_SATELLITE) // Choose map type (Only applicable for map screen) 
